...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const categories = {
        ...
        'b1-intensif-2': {
            name: 'B1+ Intensif 2',
            description: 'Pokračovanie pokročilej slovnej zásoby - peniaze, doprava, názory',
            color: '#8B4B8C'
        }
    };
    ...
    const wordData = [
        ...
        // === B1+ INTENSIF 2 KATEGÓRIA ===
        { fr: "dès que", sk: ["hneď ako", "akonáhle"], sentence_fr: "Dès que j'arriverai, je t'appellerai.", sentence_sk: "Hneď ako prídem, zavolám ti.", category: 'b1-intensif-2' },
        { fr: "aussitôt", sk: ["hneď", "okamžite"], sentence_fr: "Il est parti aussitôt après le dîner.", sentence_sk: "Odišiel hneď po večeri.", category: 'b1-intensif-2' },
        { fr: "un guichet", sk: ["prepážka"], sentence_fr: "Je vais au guichet pour acheter des tickets.", sentence_sk: "Idem na prepážku kúpiť si lístky.", category: 'b1-intensif-2' },
        { fr: "payer en espèces", sk: ["platiť v hotovosti"], sentence_fr: "Je préfère payer en espèces.", sentence_sk: "Radšej platím v hotovosti.", category: 'b1-intensif-2' },
        { fr: "payer en liquide", sk: ["platiť v hotovosti"], sentence_fr: "Vous payez en liquide ou par carte ?", sentence_sk: "Platíte v hotovosti alebo kartou?", category: 'b1-intensif-2' },
        { fr: "par carte", sk: ["kartou"], sentence_fr: "Je paie par carte bancaire.", sentence_sk: "Platím bankovou kartou.", category: 'b1-intensif-2' },
        { fr: "un chèque", sk: ["šek"], sentence_fr: "Il a payé par chèque.", sentence_sk: "Zaplatil šekom.", category: 'b1-intensif-2' },
        { fr: "par virement", sk: ["prevodom"], sentence_fr: "Je paie mon loyer par virement.", sentence_sk: "Nájomné platím prevodom.", category: 'b1-intensif-2' },
        { fr: "un distributeur de billets", sk: ["bankomat"], sentence_fr: "Je vais retirer de l'argent au distributeur de billets.", sentence_sk: "Idem vybrať peniaze z bankomatu.", category: 'b1-intensif-2' },
        { fr: "un porte-monnaie", sk: ["peňaženka"], sentence_fr: "J'ai oublié mon porte-monnaie à la maison.", sentence_sk: "Zabudol som si peňaženku doma.", category: 'b1-intensif-2' },
        { fr: "une pièce", sk: ["minca"], sentence_fr: "Il me faut une pièce de deux euros.", sentence_sk: "Potrebujem mincu dva eurá.", category: 'b1-intensif-2' },
        { fr: "un billet", sk: ["bankovka"], sentence_fr: "Il a payé avec un billet de cinquante euros.", sentence_sk: "Zaplatil päťdesiateurovou bankovkou.", category: 'b1-intensif-2' },
        { fr: "une devise", sk: ["mena"], sentence_fr: "L'euro est la devise européenne.", sentence_sk: "Euro je európska mena.", category: 'b1-intensif-2' },
        { fr: "blanchir", sk: ["bieliť", "prať (bielizeň)"], sentence_fr: "Elle fait blanchir ses chemises.", sentence_sk: "Dáva si bieliť košele.", category: 'b1-intensif-2' },
        { fr: "blanchir d'argent", sk: ["prať špinavé peniaze"], sentence_fr: "Il est accusé de blanchir d'argent.", sentence_sk: "Je obvinený z prania špinavých peňazí.", category: 'b1-intensif-2' },
        { fr: "centimes", sk: ["centy"], sentence_fr: "Cela coûte deux euros et cinquante centimes.", sentence_sk: "Stojí to dva eurá a päťdesiat centov.", category: 'b1-intensif-2' },
        { fr: "retirer", sk: ["vybrať", "odobrať"], sentence_fr: "Je vais retirer de l'argent à la banque.", sentence_sk: "Idem vybrať peniaze z banky.", category: 'b1-intensif-2' },
        { fr: "la monnaie", sk: ["drobné", "výdavok"], sentence_fr: "Gardez la monnaie !", sentence_sk: "Nechajte si drobné!", category: 'b1-intensif-2' },
        { fr: "faire la monnaie sur 5000", sk: ["rozmeníť päťtisíc"], sentence_fr: "Pouvez-vous me faire la monnaie sur 5000 ?", sentence_sk: "Môžete mi rozmeníť päťtisíc?", category: 'b1-intensif-2' },
        { fr: "rendre la monnaie", sk: ["vrátiť výdavok"], sentence_fr: "Il a oublié de me rendre la monnaie.", sentence_sk: "Zabudol mi vrátiť výdavok.", category: 'b1-intensif-2' },
        { fr: "l'épicier", sk: ["obchodník"], sentence_fr: "L'épicier est très sympatique.", sentence_sk: "Obchodník je veľmi sympatický.", category: 'b1-intensif-2' },
        { fr: "l'épicerie", sk: ["obchod s potravinami"], sentence_fr: "Je vais à l'épicerie acheter du pain.", sentence_sk: "Idem do obchodu kúpiť chlieb.", category: 'b1-intensif-2' },
        { fr: "le trac", sk: ["trému", "nervozita"], sentence_fr: "Il a toujours le trac avant de parler en public.", sentence_sk: "Pred verejným vystúpením má vždy trému.", category: 'b1-intensif-2' },
        { fr: "la trace", sk: ["stopa", "sled"], sentence_fr: "On peut voir ses traces dans la neige.", sentence_sk: "V snehu sú vidieť jeho stopy.", category: 'b1-intensif-2' },
        { fr: "un sondage d'opinion", sk: ["prieskum verejnej mienky"], sentence_fr: "Le sondage d'opinion montre une légère progression.", sentence_sk: "Prieskum verejnej mienky ukazuje mierne zlepšenie.", category: 'b1-intensif-2' },
        { fr: "un micro-trottoir", sk: ["pouličný rozhovor"], sentence_fr: "Le journaliste fait un micro-trottoir.", sentence_sk: "Novinár robí pouličné rozhovory.", category: 'b1-intensif-2' },
        { fr: "somme d'argent de poche", sk: ["suma vreckových peňazí"], sentence_fr: "C'est une belle somme d'argent de poche.", sentence_sk: "Je to pekná suma vreckových peňazí.", category: 'b1-intensif-2' },
        { fr: "se débrouiller", sk: ["radzievať si", "klbúčiť sa"], sentence_fr: "Il se débrouille bien en français.", sentence_sk: "Vo francúzštine si dobre radí.", category: 'b1-intensif-2' },
        { fr: "l'argent de poche", sk: ["vreckové peniaze"], sentence_fr: "Mes parents me donnent de l'argent de poche.", sentence_sk: "Rodičia mi dávajú vreckové peniaze.", category: 'b1-intensif-2' },
        { fr: "gérer", sk: ["spravovať", "riadiť"], sentence_fr: "Il sait bien gérer son budget.", sentence_sk: "Dobre si spravuje svoj rozpočet.", category: 'b1-intensif-2' },
        { fr: "l'enregistrement", sk: ["nahrávka", "záznam"], sentence_fr: "J'ai écouté l'enregistrement de la conférence.", sentence_sk: "Počul som nahrávku z konferencie.", category: 'b1-intensif-2' },
        { fr: "l'établissement", sk: ["zariadenie", "podnik"], sentence_fr: "C'est un établissement scolaire réputé.", sentence_sk: "Je to renomované školské zariadenie.", category: 'b1-intensif-2' },
        { fr: "se tirer", sk: ["utiecť", "zmyť sa"], sentence_fr: "Il faut qu'on se tire d'ici rapidement.", sentence_sk: "Musíme sa odtiaľto rýchlo zmyť.", category: 'b1-intensif-2' },
        { fr: "le narrateur", sk: ["rozprávač"], sentence_fr: "Le narrateur de cette histoire est très drôle.", sentence_sk: "Rozprávač tohto príbehu je veľmi vtipný.", category: 'b1-intensif-2' },
        { fr: "rapports", sk: ["vzťahy", "správy"], sentence_fr: "Il a de bons rapports avec ses collègues.", sentence_sk: "Má dobré vzťahy so svojimi kolegami.", category: 'b1-intensif-2' },
        { fr: "le cuir", sk: ["koža"], sentence_fr: "J'ai acheté une veste en cuir.", sentence_sk: "Kúpil som si koženú bundu.", category: 'b1-intensif-2' },
        { fr: "se vanter", sk: ["chváliť sa", "vychvaľovať sa"], sentence_fr: "Il se vante toujours de ses succès.", sentence_sk: "Stále sa chváli svojimi úspechmi.", category: 'b1-intensif-2' },
        { fr: "le garagiste", sk: ["automechanik"], sentence_fr: "Le garagiste répare ma voiture.", sentence_sk: "Automechanik opravuje moje auto.", category: 'b1-intensif-2' },
        { fr: "le modèle", sk: ["model", "vzor"], sentence_fr: "C'est le dernier modèle de cette voiture.", sentence_sk: "Je to najnovší model tohto auta.", category: 'b1-intensif-2' },
        { fr: "la paternité", sk: ["otcovstvo"], sentence_fr: "Il a reconnu sa paternité.", sentence_sk: "Uznal svoje otcovstvo.", category: 'b1-intensif-2' },
        { fr: "l'engin", sk: ["stroj", "zariadenie"], sentence_fr: "Cet engin est très puissant.", sentence_sk: "Tento stroj je veľmi výkonný.", category: 'b1-intensif-2' },
        { fr: "l'engine", sk: ["motor"], sentence_fr: "L'engine de l'avion fait du bruit.", sentence_sk: "Motor lietadla robí hluk.", category: 'b1-intensif-2' },
        { fr: "la peine", sk: ["trest", "bolesť"], sentence_fr: "Il a pris la peine de m'aider.", sentence_sk: "Potrápi sa, aby mi pomohol.", category: 'b1-intensif-2' },
        { fr: "le permis", sk: ["povolenie", "vodičák"], sentence_fr: "J'ai passé mon permis de conduire.", sentence_sk: "Urobil som si vodičské povolenie.", category: 'b1-intensif-2' },
        { fr: "effroi", sk: ["hrôza", "desenie"], sentence_fr: "Il regardait la scène avec effroi.", sentence_sk: "S hrôzou sa díval na výjav.", category: 'b1-intensif-2' },
        { fr: "effacées", sk: ["vymazané"], sentence_fr: "Les traces ont été effacées par la pluie.", sentence_sk: "Stopy boli dažďom vymazané.", category: 'b1-intensif-2' },
        { fr: "mensualités", sk: ["mesačné splátky"], sentence_fr: "Je paie ma voiture en mensualités.", sentence_sk: "Auto splácam mesačne.", category: 'b1-intensif-2' },
        { fr: "payer comptant", sk: ["platiť v hotovosti"], sentence_fr: "J'ai payé comptant pour avoir une réduction.", sentence_sk: "Platil som v hotovosti, aby som dostal zľavu.", category: 'b1-intensif-2' },
        { fr: "vexé", sk: ["urazený", "dotkaný"], sentence_fr: "Il était vexé par mes remarques.", sentence_sk: "Bol urazený mojimi poznámkami.", category: 'b1-intensif-2' },
        { fr: "décidément", sk: ["rozhodne", "skutočne"], sentence_fr: "Décidément, tu n'as pas de chance aujourd'hui.", sentence_sk: "Skutočne nemáš dnes šťastie.", category: 'b1-intensif-2' },
        { fr: "commettre gaffe sur gaffe", sk: ["robiť chybu za chybou"], sentence_fr: "Il commet gaffe sur gaffe depuis le matin.", sentence_sk: "Od rána robí chybu za chybou.", category: 'b1-intensif-2' },
        { fr: "des liasses de billets", sk: ["zväzky bankoviek"], sentence_fr: "Il avait des liasses de billets dans sa poche.", sentence_sk: "Mal vo vrecku zväzky bankoviek.", category: 'b1-intensif-2' },
        { fr: "rangé", sk: ["upratanný", "usporiadaný"], sentence_fr: "Sa chambre est toujours bien rangée.", sentence_sk: "Má izbu vždy dobre uprataná.", category: 'b1-intensif-2' },
        { fr: "suffoquer", sk: ["dusiť sa"], sentence_fr: "Il suffoque à cause de la fumée.", sentence_sk: "Dusí sa kvôli dymu.", category: 'b1-intensif-2' },
        { fr: "la caisse", sk: ["pokladňa", "bedna"], sentence_fr: "Payez à la caisse, s'il vous plaît.", sentence_sk: "Plaťte v pokladni, prosím.", category: 'b1-intensif-2' },
        { fr: "faisons", sk: ["robme", "urobme"], sentence_fr: "Faisons cela ensemble.", sentence_sk: "Urobme to spolu.", category: 'b1-intensif-2' },
        { fr: "disposition", sk: ["dispozícia", "k dispozícii"], sentence_fr: "Je suis à votre disposition.", sentence_sk: "Som vám k dispozícii.", category: 'b1-intensif-2' },
        { fr: "livrer", sk: ["dodať", "doručiť"], sentence_fr: "Ils vont livrer le colis demain.", sentence_sk: "Balík doručia zajtra.", category: 'b1-intensif-2' },
        { fr: "lorsqu'il monta dedans", sk: ["keď do toho nastúpil"], sentence_fr: "Lorsqu'il monta dedans, la voiture démarra.", sentence_sk: "Keď do toho nastúpil, auto naštartovalo.", category: 'b1-intensif-2' },
        { fr: "toucher", sk: ["dotýkať sa", "dostať"], sentence_fr: "Ne touche pas à ça !", sentence_sk: "Nedotýkaj sa toho!", category: 'b1-intensif-2' },
        { fr: "délicatement", sk: ["jemne", "opatrne"], sentence_fr: "Il posa délicatement le vase sur la table.", sentence_sk: "Jemne položil vázu na stôl.", category: 'b1-intensif-2' },
        { fr: "essuyer le front", sk: ["utrieť si čelo"], sentence_fr: "Il s'essuie le front avec un mouchoir.", sentence_sk: "Utiera si čelo vreckovkou.", category: 'b1-intensif-2' },
        { fr: "verdâtre", sk: ["zelenastý"], sentence_fr: "L'eau avait une couleur verdâtre.", sentence_sk: "Voda mala zelenastú farbu.", category: 'b1-intensif-2' },
        { fr: "tirées par des chevaux", sk: ["ťahané koňmi"], sentence_fr: "Les voitures d'antan étaient tirées par des chevaux.", sentence_sk: "Staroveké vozidlá boli ťahané koňmi.", category: 'b1-intensif-2' },
        { fr: "la récolte", sk: ["úroda", "zber"], sentence_fr: "Cette année, la récolte de pommes est excellente.", sentence_sk: "Tento rok je úroda jabĺk výborná.", category: 'b1-intensif-2' },
        { fr: "un truc", sk: ["vec", "niečo"], sentence_fr: "J'ai un truc important à te dire.", sentence_sk: "Mám ti povedať niečo dôležité.", category: 'b1-intensif-2' },
        { fr: "un manuel", sk: ["príručka", "manuál"], sentence_fr: "Lis le manuel avant d'utiliser l'appareil.", sentence_sk: "Pred použitím prístroja si prečítaj manuál.", category: 'b1-intensif-2' },
        { fr: "la ferraille", sk: ["šrot", "železný šrot"], sentence_fr: "Cette vieille voiture n'est bonne que pour la ferraille.", sentence_sk: "Toto staré auto sa už hodí len na šrot.", category: 'b1-intensif-2' },
        { fr: "chameau", sk: ["ťava"], sentence_fr: "Le chameau peut survivre longtemps sans eau.", sentence_sk: "Ťava dokáže dlho prežiť bez vody.", category: 'b1-intensif-2' },
        { fr: "dromadaire", sk: ["dromedár"], sentence_fr: "Le dromadaire a une seule bosse.", sentence_sk: "Dromedár má len jeden hrb.", category: 'b1-intensif-2' },
        { fr: "tenir", sk: ["držať", "vydržať"], sentence_fr: "Tiens bien la corde !", sentence_sk: "Drž pevne lano!", category: 'b1-intensif-2' },
        { fr: "la banquette", sk: ["lavica", "sedadlo"], sentence_fr: "Il s'est assis sur la banquette arrière.", sentence_sk: "Sadol si na zadné sedadlo.", category: 'b1-intensif-2' },
        { fr: "une miette", sk: ["omrvinka"], sentence_fr: "Il ne reste pas une miette de gâteau.", sentence_sk: "Nezostala ani omrvinka torty.", category: 'b1-intensif-2' },
        { fr: "un moniteur", sk: ["monitor", "inštruktor"], sentence_fr: "Le moniteur de ski donne des conseils.", sentence_sk: "Lyžiarsky inštruktor dáva rady.", category: 'b1-intensif-2' },
        { fr: "sitôt", sk: ["hneď ako"], sentence_fr: "Sitôt arrivé, il repartit.", sentence_sk: "Hneď ako prišiel, odišiel.", category: 'b1-intensif-2' },
        { fr: "la circulation", sk: ["doprava", "krvný obeh"], sentence_fr: "La circulation est dense aujourd'hui.", sentence_sk: "Dnes je doprava hustá.", category: 'b1-intensif-2' },
        { fr: "devrait être", sk: ["mal by byť"], sentence_fr: "Il devrait être là dans dix minutes.", sentence_sk: "Mal by tu byť za desať minút.", category: 'b1-intensif-2' },
        { fr: "aurait dû être", sk: ["mal byť"], sentence_fr: "Il aurait dû être plus prudent.", sentence_sk: "Mal byť opatrnejší.", category: 'b1-intensif-2' },
        { fr: "l'éloge", sk: ["chvála"], sentence_fr: "Il a fait l'éloge de son travail.", sentence_sk: "Pochválil jeho prácu.", category: 'b1-intensif-2' },
        { fr: "affirmer", sk: ["tvrdiť", "potvrdzovať"], sentence_fr: "Il affirme qu'il dit la vérité.", sentence_sk: "Tvrdí, že hovorí pravdu.", category: 'b1-intensif-2' },
        { fr: "repérer", sk: ["vysledovať", "nájsť"], sentence_fr: "J'ai repéré un bon restaurant.", sentence_sk: "Vysledoval som dobrú reštauráciu.", category: 'b1-intensif-2' },
        { fr: "estimer", sk: ["odhadovať", "vážiť si"], sentence_fr: "J'estime qu'il nous faut deux heures.", sentence_sk: "Odhadujem, že potrebujeme dve hodiny.", category: 'b1-intensif-2' },
        { fr: "craindre", sk: ["báť sa"], sentence_fr: "Je crains qu'il ne soit trop tard.", sentence_sk: "Obávam sa, že je príliš neskoro.", category: 'b1-intensif-2' },
        { fr: "suffisamment", sk: ["dostatočne"], sentence_fr: "Avez-vous suffisamment d'argent ?", sentence_sk: "Máte dostatočne peňazí?", category: 'b1-intensif-2' },
        { fr: "le but", sk: ["cieľ"], sentence_fr: "Quel est le but de cette réunion ?", sentence_sk: "Aký je cieľ tohto stretnutia?", category: 'b1-intensif-2' },
        { fr: "convaincre", sk: ["presvedčiť"], sentence_fr: "Il faut le convaincre de venir.", sentence_sk: "Treba ho presvedčiť, aby prišiel.", category: 'b1-intensif-2' },
        { fr: "évidemment", sk: ["očividne", "samozrejme"], sentence_fr: "Évidemment, il a raison.", sentence_sk: "Očividne má pravdu.", category: 'b1-intensif-2' },
        { fr: "sûrement", sk: ["iste", "určite"], sentence_fr: "Il viendra sûrement demain.", sentence_sk: "Určite príde zajtra.", category: 'b1-intensif-2' },
        { fr: "certainement", sk: ["určite"], sentence_fr: "Il acceptera certainement votre offre.", sentence_sk: "Určite prijme vašu ponuku.", category: 'b1-intensif-2' },
        { fr: "sans aucun doute", sk: ["bez akýchkoľvek pochybností"], sentence_fr: "Sans aucun doute, c'est la meilleure solution.", sentence_sk: "Bez akýchkoľvek pochybností je to najlepšie riešenie.", category: 'b1-intensif-2' },
        { fr: "se détendre", sk: ["oddychovať si"], sentence_fr: "Il faut que je me détende un peu.", sentence_sk: "Potrebujem si trochu oddýchnuť.", category: 'b1-intensif-2' },
        { fr: "la myrtille", sk: ["čučoriedka"], sentence_fr: "J'adore les tartes aux myrtilles.", sentence_sk: "Zbožňujem čučoriedkové koláče.", category: 'b1-intensif-2' },
        { fr: "le fromage blanc", sk: ["tvaroh"], sentence_fr: "Je mange du fromage blanc au petit déjeuner.", sentence_sk: "Na raňajky jem tvaroh.", category: 'b1-intensif-2' },
        { fr: "un embouteillage", sk: ["kolóna", "zápcha"], sentence_fr: "Il y a un gros embouteillage sur l'autoroute.", sentence_sk: "Na diaľnici je veľká kolóna.", category: 'b1-intensif-2' },
        { fr: "un bouchon", sk: ["kolóna", "zátka"], sentence_fr: "On est pris dans les bouchons.", sentence_sk: "Sme zachytení v kolóne.", category: 'b1-intensif-2' },
        { fr: "l'âge de vitrine", sk: ["výkladný vek"], sentence_fr: "Elle a passé l'âge de vitrine.", sentence_sk: "Už prešla výkladný vek.", category: 'b1-intensif-2' },
        { fr: "se moquer de qqn", sk: ["vysmievať sa niekomu"], sentence_fr: "Il ne faut pas se moquer des autres.", sentence_sk: "Nemalo by sa vysmievať ostatným.", category: 'b1-intensif-2' },
        { fr: "rire de qqn", sk: ["smiať sa z niekoho"], sentence_fr: "Ils rient de lui sans arrêt.", sentence_sk: "Stále sa mu smejú.", category: 'b1-intensif-2' },
        { fr: "la détente", sk: ["relaxácia", "oddych"], sentence_fr: "J'ai besoin d'un moment de détente.", sentence_sk: "Potrebujem chvíľu oddychu.", category: 'b1-intensif-2' },
        { fr: "augmenter", sk: ["zvýšiť", "stúpnuť"], sentence_fr: "Les prix ont augmenté cette année.", sentence_sk: "Ceny tento rok stúpli.", category: 'b1-intensif-2' },
        { fr: "parcourir", sk: ["prechádzať", "prejsť"], sentence_fr: "Il aime parcourir la campagne à vélo.", sentence_sk: "Rád prechádza krajinu na bicykli.", category: 'b1-intensif-2' },
        { fr: "bienfaits", sk: ["dobrodenia", "výhody"], sentence_fr: "Les bienfaits du sport sont nombreux.", sentence_sk: "Výhody športu sú mnohé.", category: 'b1-intensif-2' },
        { fr: "trajets", sk: ["cesty", "trasy"], sentence_fr: "Je fais de longs trajets pour aller au travail.", sentence_sk: "Cestujem dlho do práce.", category: 'b1-intensif-2' },
        { fr: "entraînement", sk: ["tréning"], sentence_fr: "Il va à l'entraînement tous les jours.", sentence_sk: "Chodí na tréning každý deň.", category: 'b1-intensif-2' },
        { fr: "confiance", sk: ["dôvera"], sentence_fr: "J'ai confiance en toi.", sentence_sk: "Verím ti.", category: 'b1-intensif-2' },
        { fr: "c'est suspect", sk: ["je to podozrivé"], sentence_fr: "Son comportement, c'est suspect.", sentence_sk: "Jeho správanie je podozrivé.", category: 'b1-intensif-2' },
        { fr: "c'est louche", sk: ["je to podozrivé"], sentence_fr: "Cette affaire, c'est louche.", sentence_sk: "Táto vec je podozrivá.", category: 'b1-intensif-2' },
        { fr: "c'est étrange", sk: ["je to zvláštne"], sentence_fr: "C'est étrange qu'il ne soit pas venu.", sentence_sk: "Je zvláštne, že neprišiel.", category: 'b1-intensif-2' },
        { fr: "une entorse", sk: ["vykĺbenie"], sentence_fr: "Je me suis fait une entorse à la cheville.", sentence_sk: "Vykĺbil som si členok.", category: 'b1-intensif-2' },
        { fr: "une plaque de verglas", sk: ["ľadová plocha"], sentence_fr: "Il a glissé sur une plaque de verglas.", sentence_sk: "Pošmykol sa na ľadovej ploche.", category: 'b1-intensif-2' },
        { fr: "les émissions", sk: ["relácie", "emisie"], sentence_fr: "J'aime regarder les émissions de télé.", sentence_sk: "Rád pozerám televízne relácie.", category: 'b1-intensif-2' },
        { fr: "interrompues", sk: ["prerušené"], sentence_fr: "Les émissions ont été interrompues.", sentence_sk: "Relácie boli prerušené.", category: 'b1-intensif-2' },
        { fr: "ma faveur", sk: ["moja priaznosť"], sentence_fr: "Cette décision est en ma faveur.", sentence_sk: "Toto rozhodnutie je v môj prospech.", category: 'b1-intensif-2' },
        { fr: "intervenir", sk: ["zasiahnuť", "intervenovat"], sentence_fr: "La police a dû intervenir.", sentence_sk: "Polícia musela zasiahnuť.", category: 'b1-intensif-2' },
    ];
